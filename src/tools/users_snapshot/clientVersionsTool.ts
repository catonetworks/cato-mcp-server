...
export function buildClientVersionsTool(ctx: McpToolDefContext): CatoMcpToolWrapper {
    const toolDef: McpToolDef = {
        ...
        description: `Retrieves information about device versions across all users.
            This data can be used to identify users running older client versions.
            This tool provides data on users' software and client versions from the Account Snapshot. It provides \`version\` (client version string) and \`versionNumber\` (numeric client version) along with \`osType\`. 
            ...
            Returns:
                A dictionary containing remote user version information, or an error.`,
        inputSchema: {
            type: "object",
            properties: {
                accountID: {
